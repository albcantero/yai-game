...
| Carta de amor de H. F. a Ruby | carta manuscrita ("Mi Ruby...") de **H. F. (Higgins) a Ruby**: esperanzada; habla de la "visita Oficial" del próximo mes y de que "cuando el Gobierno valide todo esto, estaremos juntos"; firmada H. F. | documento/pista de lore | **Sobre 3** (al resolver la sopa de letras del Depósito, Puzzle 4 / r4#0 = RUBY) | Depósito | **pre-borrado de Ruby**: Higgins aún confía en que el Gobierno "valide"; enlaza H. F.=Higgins con Ruby y siembra la sombra del Gobierno |
| Informes de Miquela Quirós + sopa de letras + acertijo del reloj | los informes OFICIALES de 2023 (con expediente/nº de caso/firma "Miquela Quirós") sobre *La jauría humana* + un papel con una **sopa de letras** (esconde RUBY) + un papel con el **acertijo del viajero temporal** (el reloj) | documento/pista de lore + 2 puzzles | **Sobre 6** (Recoger objeto en el Depósito) | Depósito | los informes **nombran a "Miquela Quirós"** → reveal **???→Miquela**; la sopa da el **Puzzle 4** (RUBY, desbloquea el Sobre 3); el acertijo del reloj da el **Puzzle 5** (r4#1, respuesta **15**) |
