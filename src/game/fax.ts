...
export const BLOCKS: FaxBlock[] = [
  ...
  //    mensajes y ya, SIN respuesta nuestra (nodo sin a/b). {sala-elegida} = el nombre de la sala a la que fueron. ──
  {
    ...
    nodes: {
      ...
      puzzle: { incoming: ["Hm, eso es interesante. ¿Lo habéis leído con atención?", "Todas las salas están llenas de objetos antiguos. Os iréis encontrando más.", "Guardadlo de momento. Quizá os sea útil más adelante."],
      ...
      misterio: { incoming: ["Toda la librería es un sistema lógico construido hace mucho tiempo. Para salir de aquí tenéis que descifrarlo entero.", "Hallaréis rarezas de... varias épocas. Y en algunas de ellas hay notas o comentarios de otros que han pasado por aquí antes, así que atesorarlas bien."],
