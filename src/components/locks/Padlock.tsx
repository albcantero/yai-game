...
const ROW = 30; // alto/separación de cada número de la rueda (px); DEBE coincidir con .dial-num en padlock.css
const ITEM_ANGLE = 30; // grados que gira el cilindro por número (a más grados, cilindro más "cerrado"/curvado)
