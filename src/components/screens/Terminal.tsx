            ...
            >
              ...
              <span className="faction">
                {o.icon === "room" ? (
                  ...
                  <svg className="chat-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M16 16h2v2h2v4H4v-4h2v-2h2v-2h8v2ZM15 4h2v6h-2v2H9v-2H7V4h2V2h6v2Z" /></svg>
                ) : null}
                {o.label}
              </span>
              {o.unread !== undefined && (
