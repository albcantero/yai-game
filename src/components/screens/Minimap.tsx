...
const LINKS: Link[] = [
  ...
  { from: "r1", to: "r2", pts: [[74.0, 64.2], [67.2, 56.2]], offFrom: 0 }, // Sala de Máquinas→R2: 0 (R2→S.Máquinas: -1 global)
  { from: "r1", to: "hub-almacen", pts: [[60.8, 84.9], [44, 77], [44, 64]], keys: 1, offFrom: 0, offTo: 1 }, // Sala de Máquinas→Almacén: 0; Almacén→S.Máquinas: +1
];
