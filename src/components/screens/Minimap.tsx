...
const LINKS: Link[] = [
  ...
  { from: "libreria", to: "salida", pts: [[19.8, 93.5], [19.8, 110]], item: "llave-maestra", secret: true, offFrom: 4, offTo: 0 }, // SALIDA: camino + candado ROJO (Llave Maestra). SECRETO: pasillo/salida/candado ocultos hasta abrir el candado BLANCO de la Librería
  ...
  return (
    <div className="minimap-screen" ref={rootRef}>
      ...
      <div className="minimap-view" style={frozenH ? { height: frozenH } : undefined}
        ...
        <svg ref={svgRef} className="minimap-svg" viewBox="-3 -3 106 123" preserveAspectRatio="xMidYMid meet">
