...
const ROOMS: Room[] = [
  { id: "r3", x: 52.4, y: 6.4, w: 20.0, h: 23.1, discovered: false, num: 5, name: "Biblioteca", description: "Una biblioteca privada, oculta en la trastienda de la librería. Pero está abandonada, vieja y sucia: estanterías de madera oscura con apenas unos libros, y todo cubierto por una gruesa capa de polvo. Contra una de las estanterías sigue apoyada una escalera de mano muy alta.", objeto: "Habéis obtenido el Sobre 12. Podéis abrirlo.", puzzles: 2 }, // nudo norte
  { id: "r4", x: 19.0, y: 6.3, w: 11.7, h: 20.1, discovered: false, num: 3, name: "Depósito", description: "Un depósito estrecho y en penumbra: hileras de estanterías metálicas repletas de cajas de archivo, carpetas y legajos amarillentos, ordenados por fechas y cubiertos de polvo.", objeto: "Habéis obtenido el Sobre 6. Podéis abrirlo.", puzzles: 2 }, // P4 (sopa RUBY) + P5 (reloj). P6 OCULTO (sin diseñar): contador a 2
  ...
  { id: "hub-almacen", x: 39.9, y: 41.6, w: 13.0, h: 26.2, discovered: true, num: 2, name: "Almacén de la librería", description: "Un cuarto retangular, polvoriento. Lleno de cajas de cartón apiladas, pilas de libros sin catalogar y estanterías metálicas que llegan hasta el techo.", objeto: "Habéis obtenido el Sobre 1. Podéis abrirlo.", puzzles: 1 }, // inicio; 1 puzzle: con esa llave eliges ruta (norte o sur)
  { id: "r2", x: 56.1, y: 45.7, w: 18.9, h: 12.2, discovered: false, num: 6, name: "Proyecto de sala de lectura", description: "Una sala inacabada: iba a ser una sala de lectura, pero las obras se detuvieron a medias. Andamios de metal contra las paredes sin pintar, sacos de yeso reventados y tablones de madera apoyados por todas partes.", objeto: "Habéis obtenido el Sobre 9. Podéis abrirlo.", puzzles: 3 }, // P7 (Acceso) + P8 (Taquilla) + P9 (Caja). P10 OCULTO (sin diseñar): contador a 3
  { id: "r1", x: 57.7, y: 63.0, w: 19.8, h: 25.5, discovered: false, num: 7, name: "Sala de Máquinas", description: "Una sala de máquinas ruidosa y húmeda: una caldera enorme, un cuadro eléctrico lleno de plomos, tuberías que trepan por las paredes y, en el centro del suelo de cemento, un desagüe con una rejilla oxidada.", objeto: "Habéis obtenido el Sobre 2. Podéis abrirlo.", puzzles: 2 },
